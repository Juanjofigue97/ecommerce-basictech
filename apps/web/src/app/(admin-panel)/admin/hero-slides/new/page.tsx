...
export const GRADIENT_OPTIONS = [
  { label: "Violeta", value: "from-violet-900 via-purple-900 to-slate-900" },
  { label: "Azul", value: "from-blue-900 via-cyan-900 to-slate-900" },
  { label: "Verde", value: "from-emerald-900 via-teal-900 to-slate-900" },
  { label: "Rosa", value: "from-rose-900 via-pink-900 to-slate-900" },
  { label: "Naranja", value: "from-amber-900 via-orange-900 to-slate-900" },
  { label: "Oscuro", value: "from-slate-800 via-gray-900 to-zinc-900" },
]
...
export default function NewHeroSlidePage() {
  ...
  const { createSlide } = useHeroSlidesStore()
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Nuevo Slide</h1>
          <p className="text-muted-foreground">Crea un slide para el banner principal</p>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="title" placeholder="Moda Primavera" {...register("title")} />
                    {errors.title && <p className="text-sm text-destructive">{errors.title.message}</p>}
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="subtitle">Subtítulo</Label>
                    <Input id="subtitle" placeholder="2025" {...register("subtitle")} />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="description">Descripción</Label>
                  <Input id="description" placeholder="Descubre las últimas tendencias..." {...register("description")} />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="ctaText" placeholder="Ver Colección" {...register("ctaText")} />
